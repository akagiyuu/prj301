...
VALUES 
  ('c56a4180-65aa-42ec-a945-5fd21dec0538', 'john_doe', '$2a$10$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36VQCEo8sT3c8dJ26OHWyWy', 'avatars/john.png', 'John Doe', 'Reading, Hiking', '1985-05-15', 'Enthusiastic reader and outdoor adventurer.', CURRENT_DATE),
  ('a93c7ad0-f1e5-4b66-8e0a-8e6f13bfa741', 'jane_smith', '$2a$10$7EqJtq98hPqEX7fNZaFWoO71qV6YhD3a4qHj9t3DHZ6b9DwEhUqy.', 'avatars/jane.png', 'Jane Smith', 'Traveling, Cooking', '1990-08-22', 'Loves exploring different cuisines and cultures.', CURRENT_DATE),
  ('d76b4f90-02aa-45d3-bfd9-96ce54f3d13a', 'alex_brown', '$2a$10$D4GJtq98hPqEX7fNZaFWoO3sU6YpKkNQv1qfHj9t3DHZ6b9DwEhUqw', 'avatars/alex.png', 'Alex Brown', 'Writing, Photography', '1988-11-30', 'Aspiring author and amateur photographer.', CURRENT_DATE),
  ('f0a1b2c3-d4e5-6789-abcd-ef0123456789', 'emily_white', '$2a$10$F7GJtq98hPqEX7fNZaFWoO9xI6YpKkNQv1qfHj9t3DHZ6b9DwEhUqw', 'avatars/emily.png', 'Emily White', 'Gardening, Painting', '1992-03-10', 'Artist who finds inspiration in nature.', CURRENT_DATE),
  ('8e2c4b90-1c7a-11e4-9c1e-0800200c9a66', 'mike_green', '$2a$10$L2GJtq98hPqEX7fNZaFWoO2sU6YpKkNQv1qfHj9t3DHZ6b9DwEhUqw', 'avatars/mike.png', 'Mike Green', 'Cycling, Tech', '1980-12-01', 'Tech enthusiast and avid cyclist.', CURRENT_DATE),
  ('9a8b7c6d-5e4f-3a2b-1c0d-9e8f7d6c5b4a', 'sara_connor', '$2a$10$Z1GJtq98hPqEX7fNZaFWoO2vS6YpKkNQv1qfHj9t3DHZ6b9DwEhUqw', 'avatars/sara.png', 'Sara Connor', 'Martial Arts, Strategy', '1979-02-28', 'No-nonsense fighter with a secret past.', CURRENT_DATE),
  ('1b2c3d4e-5f6a-7a8b-9c0e-1f2a3b4c5d6e', 'bruce_wayne', '$2a$10$B9GJtq98hPqEX7fNZaFWoO8sU6YpKkNQv1qfHj9t3DHZ6b9DwEhUqw', 'avatars/bruce.png', 'Bruce Wayne', 'Philanthropy, Business', '1975-04-17', 'Businessman by day, vigilante by night.', CURRENT_DATE),
  ('2c3d4e5f-6a7b-8c9d-0e1f-2a3b4c5d6e7f', 'clark_kent', '$2a$10$M3GJtq98hPqEX7fNZaFWoO5vU6YpKkNQv1qfHj9t3DHZ6b9DwEhUqw', 'avatars/clark.png', 'Clark Kent', 'Journalism, Flying', '1978-06-18', 'Mild-mannered reporter with extraordinary abilities.', CURRENT_DATE);
...
------------------------------
-- 4. Insert sample books (existing 5 books)
------------------------------
INSERT INTO books (id, isbn, posted_user_id, title, cover_path, publication_date, summary, pdf_path, view, total_rate, rate_count, created_at)
VALUES
  ('7f8e9d0c-1b2a-3c4d-5e6f-7890abcdef12', '123456789X', 'c56a4180-65aa-42ec-a945-5fd21dec0538',
   'Mystery of the Old Mansion', 'covers/old_mansion.jpg', '2010-10-10',
   'A thrilling mystery set in a secluded mansion full of hidden secrets and unexpected twists.'::text, 'pdfs/old_mansion.pdf', 150, 45, 10, CURRENT_DATE),
  ('8a9b0c1d-2e3f-4a5b-6c7d-890abcdef123', '9783161484100', 'a93c7ad0-f1e5-4b66-8e0a-8e6f13bfa741',
   'The Secret Garden', 'covers/secret_garden.jpg', '2015-04-20',
   'A heartwarming tale of rediscovery and renewal set in a long-forgotten garden.'::text, 'pdfs/secret_garden.pdf', 300, 90, 20, CURRENT_DATE),
  ('9b0c1d2e-3f4a-5b6c-7d8e-90abcdef1234', '1234567890123', 'd76b4f90-02aa-45d3-bfd9-96ce54f3d13a',
   'Adventures in Time', 'covers/time_adventures.jpg', '2018-07-15',
   'A sci-fi adventure exploring the possibilities and pitfalls of time travel.'::text, 'pdfs/time_adventures.pdf', 500, 125, 25, CURRENT_DATE),
  ('a1b2c3d4-5e6f-7890-abcd-ef1234567890', '9780747532743', 'f0a1b2c3-d4e5-6789-abcd-ef0123456789',
   'Enchanted Forest', 'covers/enchanted_forest.jpg', '2012-09-01',
   'A magical journey through an ancient forest filled with mythical creatures and lore.'::text, 'pdfs/enchanted_forest.pdf', 250, 75, 15, CURRENT_DATE),
  ('b2c3d4e5-6f70-8910-bcde-f1234567890a', '9780306406157', '8e2c4b90-1c7a-11e4-9c1e-0800200c9a66',
   'Cyberworld Chronicles', 'covers/cyberworld.jpg', '2020-01-05',
   'A futuristic tale of technology, society, and the human spirit in the digital age.'::text, 'pdfs/cyberworld.pdf', 1000, 200, 40, CURRENT_DATE);

------------------------------
-- 5. Insert additional books (Books 6 to 10)
------------------------------
INSERT INTO books (id, isbn, posted_user_id, title, cover_path, publication_date, summary, pdf_path, view, total_rate, rate_count, created_at)
VALUES
  ('6a7b8c9d-0e1f-2a3b-4c5d-6e7f8a9b0c1d', '9780307474278', '1b2c3d4e-5f6a-7a8b-9c0e-1f2a3b4c5d6e',
   'Secrets of the Vatican', 'covers/secrets_vatican.jpg', '2003-03-18',
   'A gripping thriller delving into hidden codes and ancient conspiracies.'::text, 'pdfs/secrets_vatican.pdf', 450, 85, 18, CURRENT_DATE),
  ('7b8c9d0e-1a2b-3c4d-5e6f-7a8b9c0d1e2f', '9780679783275', '2c3d4e5f-6a7b-8c9d-0e1f-2a3b4c5d6e7f',
   'Old Times, New Stories', 'covers/old_times.jpg', '1998-11-10',
   'A journey through history exploring the complexities of bygone eras.'::text, 'pdfs/old_times.pdf', 320, 70, 14, CURRENT_DATE),
  ('8c9d0e1f-2a3b-4c5d-6e7f-8a9b0c1d2e3f', '9781982137274', '9a8b7c6d-5e4f-3a2b-1c0d-9e8f7d6c5b4a',
   'The Silent Witness', 'covers/silent_witness.jpg', '2019-06-12',
   'A suspenseful thriller where a reluctant witness uncovers dark secrets.'::text, 'pdfs/silent_witness.pdf', 220, 60, 12, CURRENT_DATE),
  ('9d0e1f2a-3b4c-5d6e-7f8a-9b0c1d2e3f4a', '9783161484101', '8e2c4b90-1c7a-11e4-9c1e-0800200c9a66',
   'Infinite Horizons', 'covers/infinite_horizons.jpg', '2021-05-20',
   'An epic journey into the unknown realms of space and time.'::text, 'pdfs/infinite_horizons.pdf', 780, 150, 30, CURRENT_DATE),
  ('ae1f2b3c-4d5e-6f70-8a9b-0c1d2e3f4b5c', '1234567890128', 'c56a4180-65aa-42ec-a945-5fd21dec0538',
   'Echoes of the Past', 'covers/echoes_past.jpg', '2005-08-25',
   'A detective unravels a mystery that spans decades.'::text, 'pdfs/echoes_past.pdf', 400, 95, 19, CURRENT_DATE);
...
VALUES
  ...
  ('a1b2c3d4-5e6f-7890-abcd-ef1234567890', '9d4c2f0a-d4c6-4a1e-8c59-47e5a83c9673'),
...
VALUES
  ...
  ('a1b2c3d4-5e6f-7890-abcd-ef1234567890', '4d5e6f70-89ab-4cde-f012-3456789abcde'),
...
INSERT INTO book_genre (book_id, genre_id)
VALUES
  ('6a7b8c9d-0e1f-2a3b-4c5d-6e7f8a9b0c1d', '6a7b8c90-1d2e-3f4a-5b6c-7d8e9f0a1b2c'),  -- Note: use a valid genre id; ensure "6a7b8c90-..." is defined.
...
VALUES
  ...
  ('f6a7b8c9-0d1e-2f3a-4b5c-67890abcdef1', '8e2c4b90-1c7a-11e4-9c1e-0800200c9a66', 'a1b2c3d4-5e6f-7890-abcd-ef1234567890',
